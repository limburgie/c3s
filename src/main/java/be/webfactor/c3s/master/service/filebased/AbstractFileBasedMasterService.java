package be.webfactor.c3s.master.service.filebased;
...
public abstract class AbstractFileBasedMasterService implements MasterService {
	...
	public RepositoryConnection getRepositoryConnection() {
		...
		return RepositoryConnection.of(
				RepositoryType.valueOf(repositoryConnection.getType()),
	...
	public ResourceBundle getResourceBundle() {
		...
		for (String candidate : candidateBundleNames(locale)) {
			...
			} catch (MasterAssetNotFoundException ignored) {
