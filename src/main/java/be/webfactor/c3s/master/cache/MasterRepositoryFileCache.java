package be.webfactor.c3s.master.cache;
...
@Component
public class MasterRepositoryFileCache {

	@Getter
    @Value("${c3s.master.cache.enabled:true}")
	private boolean enabled;

	@Value("${c3s.master.cache.max-entries:10000}")
